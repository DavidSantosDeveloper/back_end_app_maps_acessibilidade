...
public class AvaliacaoService {
    private AvaliacaoRepository avaliacaoRepository;
      ...
      public OUTPUT_Avaliacao_DTO findById(Long avaliacaoId){
        ...
        return new OUTPUT_Avaliacao_DTO(avaliacao.getId(), avaliacao.getComentario(), avaliacao.getEstrelas(), avaliacao.getDt_avaliacao(), avaliacao.getUsuario().getId(), avaliacao.getLocal().getId());
    ...
    public OUTPUT_Avaliacao_DTO salvarAvaliacao(INPUT_Avaliacao_DTO avaliacaoDTO){
       ...
       Avaliacao avaliacao_com_id=avaliacaoRepository.save(avaliacao_sem_id);
        return new OUTPUT_Avaliacao_DTO(avaliacao_com_id.getId(), avaliacao_com_id.getComentario(), avaliacao_com_id.getEstrelas(), avaliacao_com_id.getDt_avaliacao(), avaliacao_com_id.getUsuario().getId(), avaliacao_com_id.getLocal().getId());
    }
    @Transactional
